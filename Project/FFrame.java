...
public class FFrame extends WindowAdapter implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e3) {
        ...
        if (str.equals("FindNext")) {
            ...
            Editor.getTextArea().select(vec1.get(1), vec2.get(1));
            Editor.getTextArea().select(vec1.get(2), vec2.get(2));
            Editor.getTextArea().select(vec1.get(3), vec2.get(3));
            Editor.getTextArea().select(vec1.get(4), vec2.get(4));
            Editor.getTextArea().select(vec1.get(5), vec2.get(5));
            // i++;
